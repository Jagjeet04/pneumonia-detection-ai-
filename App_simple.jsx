    ...
    <div style={{ fontFamily:"'IBM Plex Sans','Helvetica Neue',sans-serif", background: C.white, color: C.text, minHeight:"100vh" }}>
      ...
      <motion.nav style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:32 }}>
          {["Workstation","Architecture","Performance","Interpretability","Research"].map(t => (
        ...
        <div style={{ position:"relative", zIndex:2, padding:"100px 80px 80px", maxWidth:700 }}>
          <motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} transition={{duration:0.7}}>
            ...
            <p style={{ fontSize:13, color:"#93B8E0", lineHeight:1.9, maxWidth:480, marginBottom:36, fontWeight:300 }}>
              Hybrid Vision Transformer + CNN achieving 98.4% accuracy with 99.1% recall.
            ...
            <div style={{
              ...
              {[["98.4%","Accuracy"],["99.1%","Recall"],["97.2%","Precision"],["0.997","AUC-ROC"]].map(([v,l], i) => (
                <div key={l} style={{
                  padding:"12px 22px",
            ...
            <div style={{ padding:"24px", overflowX:"auto" }}>
              ...
              <div style={{
                ...
                <ul style={{ color:C.amber, fontSize:10, marginTop:12, paddingLeft:20, lineHeight:1.8 }}>
                  <li><strong>Superior Performance:</strong> Hybrid ViT-CNN achieves 98.4% accuracy, 6.3% higher than the best baseline (ViT-Base)</li>
                  <li><strong>Exceptional Recall:</strong> 99.1% recall ensures minimal false negatives - critical for medical screening</li>
                  ...
                  <li><strong>Clinical Viability:</strong> High precision (97.2%) reduces false positives, minimizing unnecessary follow-ups</li>
                </ul>
              </div>
              ...
              <div style={{
                ...
                {[
                  { label: "Best Accuracy", value: "98.4%", model: "Hybrid ViT-CNN" },
                  { label: "Best Recall", value: "99.1%", model: "Hybrid ViT-CNN" },
      ...
      <section id="interpretability" style={{ background:C.field, padding:"64px 40px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>

          <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:32 }}>
            <div style={{ width:3, height:20, background:C.blue, borderRadius:2 }} />
            <span className="mono" style={{ fontSize:10, color:C.blue, letterSpacing:3 }}>MODEL INTERPRETABILITY</span>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p className="mono" style={{ fontSize:9, color:C.muted, lineHeight:1.6 }}>
                Integrated Gradients, Grad-CAM visualizations, and infection rate analysis for clinical decision support
              </p>
            </div>
            ...
            <div style={{ padding:"24px" }}>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))", gap:24, marginBottom:32 }}>
                ...
                <div style={{
                  padding:"20px", border:`1px solid ${C.border}`, borderRadius:8,
                  ...
                  <div style={{
                    ...
                    fontFamily:"'IBM Plex Mono',monospace",
                  }}>PIXEL ATTRIBUTION</div>
                  
                  <h4 style={{ fontSize:14, fontWeight:600, color:C.navy, marginBottom:12 }}>
                    🔍 Integrated Gradients
                  </h4>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      background:"linear-gradient(45deg, #0066CC20 0%, transparent 50%, #0066CC20 100%)"
                    }} />
                    <div style={{ textAlign:"center", zIndex:1 }}>
                      <div style={{ fontSize:24, marginBottom:8 }}>🔍</div>
                      <div className="mono" style={{ fontSize:10, color:C.muted }}>Attribution Heatmap</div>
                    </div>
                    {/* Simulated attribution overlay */}
                    <div style={{
                      position:"absolute", top:20, left:30, width:80, height:60,
                      background:"rgba(0,102,204,0.3)", borderRadius:4,
                      border:"1px solid rgba(0,102,204,0.5)"
                    }} />
                    <div style={{
                      position:"absolute", bottom:30, right:40, width:60, height:40,
                      background:"rgba(0,102,204,0.2)", borderRadius:4,
                      border:"1px solid rgba(0,102,204,0.4)"
                    }} />
                  </div>
                  
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6 }}>
                    <strong className="mono">FEATURE:</strong> Pixel-level importance mapping showing which image regions contribute most to the prediction.
                  </div>
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6, marginTop:8 }}>
                    <strong className="mono">CLINICAL VALUE:</strong> Highlights specific pathological indicators radiologists should examine.
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      position:"absolute", inset:0,
                      background:"linear-gradient(135deg, #00875A20 0%, transparent 50%, #00875A20 100%)"
                    }} />
                    <div style={{ textAlign:"center", zIndex:1 }}>
                      <div style={{ fontSize:24, marginBottom:8 }}>🎯</div>
                      <div className="mono" style={{ fontSize:10, color:C.muted }}>Class Activation Map</div>
                    </div>
                    {/* Simulated Grad-CAM overlay */}
                    <div style={{
                      position:"absolute", top:40, left:50, width:100, height:80,
                      background:"radial-gradient(circle, rgba(0,135,90,0.6) 0%, rgba(0,135,90,0.1) 70%)",
                      borderRadius:"50%"
                    }} />
                    <div style={{
                      position:"absolute", top:60, right:60, width:40, height:40,
                      background:"radial-gradient(circle, rgba(0,135,90,0.4) 0%, rgba(0,135,90,0.1) 70%)",
                      borderRadius:"50%"
                    }} />
                  </div>
                  
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6 }}>
                    <strong className="mono">FEATURE:</strong> Gradient-weighted class activation mapping showing discriminative regions.
                  </div>
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6, marginTop:8 }}>
                    <strong className="mono">CLINICAL VALUE:</strong> Visualizes where the model "looks" for pneumonia patterns.
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ marginBottom:12 }}>
                      <div className="mono" style={{ fontSize:8, color:C.muted, marginBottom:4 }}>OVERALL INFECTION PROBABILITY</div>
                      <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                        <div style={{ fontSize:24, fontWeight:600, color:C.amber }}>87.3%</div>
                        <div className="mono" style={{ fontSize:8, color:C.green }}>↑ 12.4% vs baseline</div>
                      </div>
                    </div>
                    
                    <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8 }}>
                      {[
                        { label: "Upper Lobe", value: "92.1%", trend: "↑" },
                        { label: "Lower Lobe", value: "84.6%", trend: "↑" },
                        { label: "Left Lung", value: "89.2%", trend: "↑" },
                        { label: "Right Lung", value: "85.4%", trend: "↑" }
                      ].map((region, i) => (
                        <div key={i} style={{
                          padding:"8px", background:C.white,
                          border:`1px solid ${C.border}`, borderRadius:4
                        }}>
                          <div className="mono" style={{ fontSize:7, color:C.muted }}>{region.label}</div>
                          <div className="mono" style={{ fontSize:10, fontWeight:600, color:C.text }}>
                            {region.value} {region.trend}
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6 }}>
                    <strong className="mono">FEATURE:</strong> Regional infection probability analysis across lung zones.
                  </div>
                  <div style={{ fontSize:10, color:C.sub, lineHeight:1.6, marginTop:8 }}>
                    <strong className="mono">CLINICAL VALUE:</strong> Quantifies infection severity by anatomical region.
                  </div>
                </div>
              </div>
              ...
              {/* Technical Details */}
              <div style={{
                padding:"20px", background:C.blueL,
                border:`1px solid ${C.blue}`, borderRadius:8,
                marginBottom:24
              }}>
                <h4 style={{ fontSize:12, fontWeight:600, color:C.blue, marginBottom:12 }}>
                  ⚙️ Technical Implementation
                </h4>
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))", gap:16 }}>
                  <div>
                    <div className="mono" style={{ fontSize:9, color:C.blue, fontWeight:600, marginBottom:4 }}>
                      INTEGRATED GRADIENTS
                    </div>
                    <ul style={{ fontSize:9, color:C.sub, margin:0, paddingLeft:16, lineHeight:1.5 }}>
                      <li>Baseline interpolation with 50 steps</li>
                      <li>Pixel-wise attribution scores</li>
                      <li>SmoothGrad integration for noise reduction</li>
                    </ul>
                  </div>
                  <div>
                    <div className="mono" style={{ fontSize:9, color:C.green, fontWeight:600, marginBottom:4 }}>
                      GRAD-CAM
                    </div>
                    <ul style={{ fontSize:9, color:C.sub, margin:0, paddingLeft:16, lineHeight:1.5 }}>
                  ...
                  <div>
                    <div className="mono" style={{ fontSize:9, color:C.amber, fontWeight:600, marginBottom:4 }}>
                      INFECTION ANALYSIS
                    </div>
                    <ul style={{ fontSize:9, color:C.sub, margin:0, paddingLeft:16, lineHeight:1.5 }}>
                      <li>Monte Carlo dropout uncertainty</li>
                      <li>Ensemble prediction averaging</li>
                      <li>Regional probability mapping</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                padding:"16px", background:C.amberL,
                border:`1px solid ${C.amberL}`, borderRadius:8
              }}>
                ...
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))", gap:12 }}>
                  {[
                    ...
                    <div key={i} style={{ fontSize:9, color:C.amber, display:"flex", alignItems:"center", gap:6 }}>
                      <span style={{ color:C.green, fontWeight:"bold" }}>✓</span>
                      {benefit}
                    </div>
                  ))}
                </div>
